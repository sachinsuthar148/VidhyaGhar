    ...
    <div>
      ...
      <div className="container">
        ...
        <form >
            ...
            <input className='input-field' type="text" id="fathername" name="fathername" placeholder='Enter Father Name' required/>
            <br />

            <input className='input-field' type="text" id="mothername" name="mothername" placeholder='Enter Mother Name' required/>
            <br />

            <input className='input-field' type="email" id="email" name="email" placeholder='Enter Email' required/>
            <br />

            <input className='input-field' type="date" id="dob" name="dob" placeholder='Enter DOB' required/>
            <br />


            <input className='input-field' type="number" id="rollno" name="rollno" placeholder='Enter Roll No.' required/>
            <br />
